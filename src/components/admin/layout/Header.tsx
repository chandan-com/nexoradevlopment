...
export default function Header({ setOpen }: HeaderProps) {
  return (
    <header className="sticky top-0 z-40 flex h-20 items-center justify-between overflow-hidden  bg-background/80 px-3 md:px-3 backdrop-blur-xl">
      {/* Left */}
...
>
  <Menu size={22} />
      ...
      <div className="flex items-center gap-4">
        ...
        <button className="relative rounded-xl border border-border p-2 transition hover:bg-muted">
