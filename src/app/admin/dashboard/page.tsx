  ...
  <AnalyticsChart/>
        ...
        <div className="rounded-2xl shadow-xl bg-card p-4 sm:p-6">
          ...
          <div className="space-y-3">
            ...
            href="blog/add"
            >
            <button className="w-full mb-3 rounded-xl bg-blue-600 py-3 text-white transition hover:bg-blue-700 cursor-pointer">
              + Add Blog
            </button>
              </Link>
              <Link
                href="portfolio/add"
                >
            <button className="w-full mb-3 rounded-xl border border-border py-3 transition hover:bg-muted hover:bg-blue-700 cursor-pointer">
              + Add Portfolio
            </button>
            </Link>
            <Link 
